...
class UserPermission extends Model
{
    ...
    protected $fillable = ['department_id','designation_id','recruitment_view','recruitment_modify','holiday_view','holiday_modify','performance_view','performance_modify','add_skills_view',
                        ...
                        'user_log_view','salary_set_up_view','salary_set_up_modify','released_employees_view','released_employees_modify','leave_application_view','leave_application_modify','team_member_view',
