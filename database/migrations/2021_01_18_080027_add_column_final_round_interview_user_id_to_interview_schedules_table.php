...
class AddColumnFinalRoundInterviewUserIdToInterviewSchedulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('interview_schedules', function (Blueprint $table) {
            $table->dropForeign('interview_schedules_final_round_interview_user_id_foreign');
            $table->dropIndex('interview_schedulesfinal_round_interview_user_id_index');
