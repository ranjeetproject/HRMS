                    ...
                    <td>
                        <a href="#" target="_blank"
                           style="display:inline-block; width:100%; text-align: center;float:left;"><img
                                src="{{asset('images/emailTemplateLogo.png')}}" width="618px" alt="" style="float: left"/></a>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" bgcolor="#f5f5f5" border="0" width="100%"
                ...
                <tr>
                    <td align="center" style="padding:20px 20px 40px 20px;font-size:16px;line-height:22px">
                        ...
                        <a href="{{action('UserController@resetPasswordForm',['email'=>$user->email,'token'=>$user->remember_token])}}" class="btn btn-primary">Reset Password</a>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding:20px 20px 40px 20px;font-size:16px;line-height:22px">
                ...
                <tr>
                    <td align="center" bgcolor="#1e1e2d" style="padding-top: 20px; padding-bottom: 20px;">
                        <span
                            style="color:#717070;font-style:normal;font-variant-caps:normal;font-weight:normal;letter-spacing:normal;text-align:-webkit-left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;font-family:Arial,sans-serif;font-size:12px;line-height:18px">&copy; {{date('Y')-1}} - {{date('Y')}} Track-Parenting
                        ...
                        <span
                            style="color:#717070;font-style:normal;font-variant-caps:normal;font-weight:normal;letter-spacing:normal;text-align:-webkit-left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;font-family:Arial,sans-serif;font-size:12px;line-height:18px">URL: <a
                                href="{{asset('/')}}" style="color:#cccccc;">www.trackparenting.com</a>; Email: <a
                                href="mailto:carnegierissecaroline@gmail.com"
                                style="color:#cccccc;">trackparenting@gmail.com</a></span>
                    </td>
                </tr>
                </tbody>
            </table>
