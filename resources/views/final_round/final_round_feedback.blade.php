                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input
                                                class="form-control"
                                                type="hidden"
                                                name="recruitment_id" id="recruitment_id" value="">
                                                <input
                                                class="form-control"
                                                type="hidden"
                                                name="schedule_id" id="schedule_id" value="">
                                               <label class="form-control-label" for="name_of_candidate">Name of Candidate</label>
                                                <input
                                                    ...
                                                    maxlength="191"
                                                    value="{{old('name_of_candidate')}}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <input
                                                    ...
                                                    maxlength="191"
                                                    value="{{old('interview_scheduling_date')}}" readonly>
                                        ...
                                        <div class="form-group">
                                                    <label class=" form-control-label" for="interview_scheduling_time">Interview Time</label>
                                                        <input
                                                                ...
                                                                maxlength="191"
                                                                value="{{old('interview_scheduling_time')}}" readonly>
