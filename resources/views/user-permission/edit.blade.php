                                            ...
                                            <table class="table table-bordered table-striped data-table dt-select cms_table_width" id="skills_table">
                                                ...
                                                <tr class="g">
                                                 ...
                                                 <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="employees_leaves_view" id="skill" value="1" @if(@$permission['user_permission']->employees_leaves_view == 1) {{'checked'}} @endIf style="margin-left:3%" >
                                                    </th>
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="employees_leaves_details_view" id="skill" value="1" @if(@$permission['user_permission']->employees_leaves_details_view == 1) {{'checked'}} @endIf style="margin-left:3%" >
                                                    </th>
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="extra_half_day_leaves_details_view" id="skill" value="1" @if(@$permission['user_permission']->extra_half_day_leaves_details_view == 1) {{'checked'}} @endIf style="margin-left:3%" >
                                                    </th>
                                                    <th>ExtraAndHalfDay Leaves Details</th>
                                                </tr>
                                                <tr class="g">
                                                    <!-- <th style="text-align:center;"><input type="checkbox" id="select-all"/></th> -->
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="leaves_details_view" id="skill" value="1" @if(@$permission['user_permission']->leaves_details_view == 1) {{'checked'}} @endIf style="margin-left:3%" >
                                                    </th>
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="add_leaves_bank_view" id="skill" value="1" @if(@$permission['user_permission']->add_leaves_bank_view == 1) {{'checked'}} @endIf style="margin-left:3%" >
                                                    </th>
                                                    <th>Add Leaves Bank</th>
                                                </tr>
                                                <tr class="m">
                                                    <!-- <th style="text-align:center;"><input type="checkbox" id="select-all"/></th> -->
                                                    <th>
