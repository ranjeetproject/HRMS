                                        ...
                                        <div class="form-group row">
                                            ...
                                            <table class="table table-bordered table-striped data-table dt-select cms_table_width" id="skills_table">
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="pending_approve_leave_view" id="skill" value="1" style="margin-left:3%" >
                                                    </th>
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="extra_half_day_leaves_details_view" id="skill" value="1" style="margin-left:3%" >
                                                    </th>
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="leaves_details_view" id="skill" value="1" style="margin-left:3%" >
                                                    </th>
                                                ...
                                                <tr class="g">
                                                    ...
                                                    <th>
                                                        <label class="col-md-2 form-control-label" for="skill_name"> View </label>
                                                        <input type="checkbox" class="form-check-input g1" name="add_leaves_bank_view" id="skill" value="1" style="margin-left:3%" >
                                                    </th>
