                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a
                                    ...
                                    Home</a></li>
                            <li class="breadcrumb-item"><a
                                    href="{{action('EmployeeController@index')}}"><i class="fa fa-pray"></i>
                                    Employee</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    class="form-control custom-select {{ $errors->has("category") ? 'is-invalid' : '' }}"
                                                    name="category" id="category">
                                                    <option value="">Select One</option>
                                                   @foreach($category as $categoryValue)
                                                        <option value="{{$categoryValue->id}}">{{$categoryValue->cname}}</option>
                                                    @endforeach
                                                </select>
