<aside class="main-sidebar elevation-4 sidebar-dark-maroon">{{--main-sidebar sidebar-dark-primary elevation-4--}}
    <a href="{{action('LoginController@getAdminDashboard')}}" class="brand-link navbar-primary">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu">
                <li class="nav-item">
                    <a class="nav-link {{ (request()->segment(2) == 'dashboard') ? 'active' : '' }}"
                       href="{{action('LoginController@getAdminDashboard')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ (request()->segment(2) == 'member') ? 'active' : '' }}"
                       href="{{action('EmployeeController@index')}}">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Member Manage
                        </p>
                  ...
                  <li class="nav-item ">
                    <a class="nav-link {{ (request()->segment(2) == 'category') ? 'active' : '' }}"
                        href="{{action('CategoryController@index')}}">
