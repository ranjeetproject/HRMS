...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h5>Employees Leaves</h5>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a
                                href=""> <i class="fas fa-home"></i> Home</a></li>
                        <li class="breadcrumb-item active"><i class="nav-icon fas fa-user-tie"></i>&nbsp;Employees Leaves</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped data-table dt-select cms_table_width" id="employees_leaves_table">
                                            <thead>
                                            <tr>
...
@section('customJsInclude')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = $('#employees_leaves_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name',defaultContent:'null', orderable: true},
