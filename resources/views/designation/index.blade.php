                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><i class="nav-icon fab fa-dyalog"></i> Designation</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            ...
                            <form action="{{action('DesignationController@store')}}" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control {{ $errors->has('designation_name') ? 'is-invalid' : '' }}"
                                                    ...
                                                    maxlength="191" value="{{old('designation_name')}}">
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped data-table dt-select cms_table_width" id="designation_table">
                                                <thead>
                                                <tr>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#skillForm').validate({
                ...
                messages: {
                    designation_name: {
                        required: "This designation name field is required.",
                    },
                },
                errorElement: "span",
            ...
            $('#designationForm').submit(function(){
